    ...
    public function callSearch($email, $params)
    {
        ...
        if ($tab == "instagram") {
            ...
            if ($params["category"] != "All") {
                $where["category_niche"] = $params["category"];
            }
            if ($params["username"] != "") {
        ...
        if ($tab == "tiktok") {
            $infs = DB::table("influencers_tiktok")->where("username", $params["username"])->get()->toArray();
        ...
        if ($tab == "youtube") {
            $infs = DB::table("influencers_youtube")->where("username", $params["username"])->get()->toArray();
            foreach ($infs as $key => $value) {
        ...
        if ($tab == "twitter") {
            $infs = DB::table("influencers_twitter")->where("username", $params["username"])->get()->toArray();
            foreach ($infs as $key => $value) {
        ...
        if ($tab == "pinterest") {
            $infs = DB::table("influencers_pinterest")->where("username", $params["username"])->get()->toArray();
            foreach ($infs as $key => $value) {
        ...
        if ($tab == "linkedin") {
            $infs = DB::table("influencers_linkedin")->where("username", $params["username"])->get()->toArray();
            foreach ($infs as $key => $value) {
