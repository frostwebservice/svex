...
const Page = (props) => {
  ...
  useEffect(() => {
    dispatch(
      getSocialProfile({
        email: email,
        infname: window.location.pathname.split('/')[3],
        socialtype: 'total'
      })
    );
  }, [dispatch]);
  ...
  const showReach = () => {
    ...
    let total_number =
      (socialinfo && socialinfo['instagram']
        ? socialinfo['instagram'].follower_count
        : 0) +
      (socialinfo && socialinfo['pinterest']
        ? socialinfo['pinterest'].follower_count
        : 0) +
      (socialinfo && socialinfo['tiktok']
        ? socialinfo['tiktok'].follower_count
        : 0) +
      (socialinfo && socialinfo['twitter']
        ? socialinfo['twitter'].follower_count
        : 0) +
      (socialinfo && socialinfo['youtube']
        ? socialinfo['youtube'].follower_count
        : 0);
  ...
  const showTooltipReach = () => {
    ...
    txt +=
      'Instagram followers: ' +
      (socialinfo && socialinfo['instagram']
        ? formatNumber(socialinfo['instagram'].follower_count)
        : 0) +
      '\n' +
      'Tiktok followers: ' +
      (socialinfo && socialinfo['tiktok']
        ? formatNumber(socialinfo['tiktok'].follower_count)
        : 0) +
      '\n' +
      'Youtube followers: ' +
      (socialinfo && socialinfo['youtube']
        ? formatNumber(socialinfo['youtube'].follower_count)
        : 0) +
      '\n' +
      'Twitter followers: ' +
      (socialinfo && socialinfo['twitter']
        ? formatNumber(socialinfo['twitter'].follower_count)
        : 0) +
      '\n' +
      'Pinterest followers: ' +
      (socialinfo && socialinfo['pinterest']
        ? formatNumber(socialinfo['pinterest'].follower_count)
        : 0) +
      '\n';
    return txt;
  };
  ...
  return (
    <>
      ...
      <JobListCard
        ...
        open={jobDialog.open}
        currentTab={selectedStat}
        infID={tmp && tmp.id}
      />
      <GroupListCard
        onClose={groupDialog.handleClose}
            ...
            >
              ...
              >
                ...
                >
                  <Avatar
                    src={
                      tmp && tmp.profile_pic_url_hd
                        ? tmp.profile_pic_url_hd
