...
export const CardBottom = (props) => {
  ...
  const renderNiche = (tmp) => {
    ...
    if (!exist) {
      return tmp && tmp.category_niche ? (
        <div className="profile-niche" key={tmp.category_niche}>
          {' '}
          {tmp.category_niche}
        </div>
      ) : (
      ...
      const renderingNiches = niches.map((niche) => (
        <div className="profile-niche" key={niche}>
          {' '}
          {niche.replace(/"/g, '')}
        </div>
      ));
  ...
  const renderDivNiche = (category) => {
    let exist = category.includes('[');

    if (!exist) {
      return category;
    } else if (exist) {
      let niches = category ? category : '';
      niches = niches.replace('[', '').replace(']', '');
      niches = niches.split(',');

      const renderingNiches = niches.map(
            ...
            >
              ...
              >
                <List>
                    ...
                    <ListItemText
                      ...
                      primary={
                        ...
                        >
                          {influencer
                            ? 'Language: ' +
                              influencer.language.charAt(0).toUpperCase() +
                              influencer.language.slice(1)
                            : ''}
                        </Typography>
                      }
                    />
                    ...
                    <ListItemText
                      ...
                      primary={
                        ...
                        >
                          {influencer
                            ? 'Gender: ' +
                              influencer.gender.charAt(0).toUpperCase() +
                              influencer.gender.slice(1)
                            : ''}
                        </Typography>
                      }
                    />
                  ...
                  <ListItem className="custom-item" disableGutters>
                    <ListItemAvatar>
