...
var once = false;
// console.log("called")
var tmpData = { app_message: 0, app_job: 0, app_add: 0, app_signup: 0, app_membership: 0, mail_membership: 0, mail_message: 0, mail_add: 0, mail_signup: 0, mail_job: 0 };
export const AccountNotificationsSettings = () => {
  ...
  if (!once) {
    axios.post('/api/get_notifysettings', { user_email: JSON.parse(localStorage.getItem('email')) })
      .then(response => {
        console.log("tmpData", tmpData)
        console.log("res", response.data.data)

        const res = response.data.data
        if (res.app_message != tmpData.app_message || res.app_add != tmpData.app_add || res.app_membership != tmpData.app_membership || res.app_job != tmpData.app_job || res.app_signup != tmpData.app_signup || res.mail_message != tmpData.mail_message || res.mail_add != tmpData.mail_add || res.mail_membership != tmpData.mail_membership || res.mail_job != tmpData.mail_job || res.mail_signup != tmpData.mail_signup) {
          SetNotifysettings({
            ...notifysettings,
  ...
  const handleChange = (kind) => {
    ...
    switch (kind) {
      case "app_message":
        ...
        axios.post('/api/update_notifysettings', { notifysettings: notifysettings, user_email: JSON.parse(localStorage.getItem('email')) })
          .then(response => {
      ...
      case "app_add":
        ...
        break
      case "app_membership":
        notifysettings.app_membership = notifysettings.app_membership == 1 ? 0 : 1
        axios.post('/api/update_notifysettings', { notifysettings: notifysettings, user_email: JSON.parse(localStorage.getItem('email')) })
          .then(response => {
      ...
      case "mail_membership":
        notifysettings.mail_membership = notifysettings.mail_membership == 1 ? 0 : 1
        axios.post('/api/update_notifysettings', { notifysettings: notifysettings, user_email: JSON.parse(localStorage.getItem('email')) })
          .then(response => {
          ...
          >
            ...
            >
              ...
              >
                ...
                <Switch
                  checked={notifysettings.app_message && notifysettings.app_message == 1 ? true : false}
              ...
              >
                ...
                <Switch
                  checked={notifysettings.app_job && notifysettings.app_job == 1 ? true : false}
              ...
              >
                ...
                <Switch
                  checked={notifysettings.app_signup && notifysettings.app_signup == 1 ? true : false}
              ...
              >
                ...
                <Switch
                  ...
                  checked={notifysettings.app_add && notifysettings.app_add == 1 ? true : false}
                />
              </Stack>
              <Stack
                alignItems="flex-start"
              ...
              >
                ...
                <Switch
                  ...
                  checked={notifysettings.app_membership && notifysettings.app_membership == 1 ? true : false}
                />
              </Stack>
            </Stack>
          </Grid>
            ...
            >
              ...
              >
                ...
                <Switch
                  ...
                  checked={notifysettings.mail_message && notifysettings.mail_message == 1 ? true : false}
                />
              </Stack>
              <Stack
                alignItems="flex-start"
              ...
              >
                ...
                <Switch
                  ...
                  checked={notifysettings.mail_job && notifysettings.mail_job == 1 ? true : false}
                />
              </Stack>
              <Stack
                alignItems="flex-start"
              ...
              >
                ...
                <Switch
                  ...
                  checked={notifysettings.mail_signup && notifysettings.mail_signup == 1 ? true : false}
                />
              </Stack>
              <Stack
                alignItems="flex-start"
              ...
              >
                ...
                <Switch
                  ...
                  checked={notifysettings.mail_add && notifysettings.mail_add == 1 ? true : false}
                />
              </Stack>
              <Stack
                alignItems="flex-start"
              ...
              >
                ...
                <Switch
                  ...
                  checked={notifysettings.mail_membership && notifysettings.mail_membership == 1 ? true : false}
                />
              </Stack>
            </Stack>
          </Grid>
