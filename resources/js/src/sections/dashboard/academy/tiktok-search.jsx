...
import { categoryOptions, locationOptions, followersFromOptions, followersToOptions, totallikesOptions, ageOptions, genderOptions, languageOptions, ttengagementOptions, avglikesOptions, avgcommentsOptions } from './data'
        ...
        if (runTab && runTab.runsavestate && runTab.runsavestate.tab == "tiktok") {
            ...
            searchs.map((search) => {
                if (search.id == runTab.runsavestate.id) {
                    ...
                    setSearchParams({
                        ...searchParams,
                        keywords: search.keywords == null ? "All" : search.keywords,
                        hashtags: search.hashtags == null ? "All" : search.hashtags,
                        category: search.category == null ? "All" : search.category,
                        location: search.location == null ? "All" : search.location,
                        followers_from: search.followers_from == null ? "All" : search.followers_from,
                        followers_to: search.followers_to == null ? "All" : search.followers_to,
                    ...
                    >
                        <Box sx={{ flexGrow: 1 }}>
                            <TextField
                                ...
                                SelectProps={{ native: true }}
                            >
                                {ttengagementOptions.map((option) => (
                                    <option
                                        key={option}
                                        value={option}
                                    >
