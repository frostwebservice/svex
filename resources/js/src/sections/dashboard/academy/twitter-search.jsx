      ...
      searchs.map((search) => {
        if (search.id == selectedSearch) {
          let temp = {
            ...
            total_favorites:
              search.total_favorites == null ? 'All' : search.total_favorites,
        ...
        <Grid container spacing={3}>
          ...
          {/* <Grid item xs={12} md={2} sm={4}
                    ...
                    >
                        <Box sx={{ flexGrow: 1 }}>
                            <TextField
                                value={searchParams.total_favorites}
                                onChange={(e) => setSearchParams({ ...searchParams, total_favorites: e.target.value })}
                                fullWidth
                                ...
                                SelectProps={{ native: true }}
                            >
                                {totalfavoritesOptions.map((option) => (
                                    <option
                                        key={option}
                                        value={option}
                                    >
...
export default connect(mapStateToProps)(TwitterSearch);
